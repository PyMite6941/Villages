...
const rows = [
  ['Finding the right group', 'Manual channel browsing and invitations', 'Profiles, interests, and Village discovery built around learning goals'],
  ['Turning confusion into action', 'Depends on whoever replies first', 'Topic Explorer produces plain-language summaries, checklists, and next steps'],
  ['Private cohorts', 'Possible, but usually mixed with general chat', 'Public, private, and invite-only Villages are part of the core flow'],
  ['Learning context', 'Files and threads scatter across channels', 'Discussions, challenges, courses, and AI help sit beside the Village'],
]
...
export default function SlackComparison() {
  useEffect(() => {
    setPageMeta({
      ...
      description: 'Compare Slack with Villages for study cohorts, adult learning circles, and community organizers who need more than another chat feed.',
      ...
      <main>
        <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:py-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600 dark:text-gray-300">
              Slack works when everyone already knows where to go and what to do. Villages is better when people need to discover the right group, understand confusing material, and keep learning together after the first message.
            </p>
            ...
            <table className="w-full min-w-[720px] border-collapse text-left text-sm">
              ...
              <tbody>
                {rows.map(([need, slack, villages]) => (
                  <tr key={need} className="border-b border-amber-100 last:border-0 dark:border-gray-800">
        ...
        <section className="mx-auto grid max-w-6xl gap-5 px-4 py-12 sm:px-6 md:grid-cols-3">
          <article className="rounded-lg border border-amber-100 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            <h2 className="mt-4 text-lg font-semibold">Use Slack when the group is already organized.</h2>
          ...
          <article className="rounded-lg border border-amber-100 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
              Villages helps learners find the right circle by goal, interest, level, and learning style.
            </p>
          </article>
          <article className="rounded-lg border border-amber-100 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
              Built-in AI turns confusing material into summaries, checklists, and next steps the group can discuss.
            </p>
          </article>
        </section>
          ...
          <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_0.9fr]">
            ...
            <div className="rounded-lg border border-amber-100 bg-amber-50 p-5 dark:border-gray-800 dark:bg-gray-800">
              ...
              <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                Start with an email link, then create or join a Village around the subject your group cares about.
              </p>
              <div className="mt-4">
                <MagicLinkSignup source="slack_comparison" buttonLabel="Send my join link" compact />
              </div>
            </div>
          </div>
        </section>
