...
const faqItems = [
  {
    question: 'Does Villages have a public price list yet?',
    answer:
      'No. Villages does not have a public price list yet, so organizers can join, create the first Village for their group, and see whether the product fits their community.',
  },
  {
    question: 'What can organizers use Villages for today?',
    answer:
      'Organizers can help people find the right circle, keep learning context together, and turn hard topics into next steps.',
  },
  {
    question: 'What is this pricing page not promising?',
    answer:
      'This page does not promise a public price list, checkout or billing terms, discounts, plan names, or enterprise commitments.',
  },
]
...
export default function Pricing() {
  useEffect(() => {
    setPageMeta({
      ...
      description:
        'See how learning-community organizers can start with Villages early access, create a focused group, and move interested members through the join path.',
      canonicalPath: '/pricing',
    })
    setFAQJsonLd('pricing-faq-schema', faqItems)
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:py-20">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-gray-600 dark:text-gray-300">
                Villages does not have a public price list yet. For now, organizers can join, create
                the first Village for their group, and see whether the product fits the community
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-white/80">
                      Join first, then build the Village your group needs.
                    </p>
                  </div>
                </div>
              </div>
              <div className="mt-4 space-y-3">
                {[
                  [
                    ...
                    'Start with the group you already organize or the topic your members are asking for.',
                  ],
                  [
                    'Use public or private access',
                    'Open discovery when it helps, or use private codes for a closed cohort.',
                  ],
                  [
                    'Keep pricing flexible for now',
                    'No checkout step is required to evaluate the organizer fit.',
                  ],
                ].map(([title, text]) => (
        ...
        <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-gray-600 dark:text-gray-300">
              The first organizer experience is about fit: a focused place for the people, topics,
              and learning loops your group already needs.
            </p>
          </div>
        ...
        <section className="border-y border-amber-100 bg-white dark:border-gray-800 dark:bg-gray-900">
          <div className="mx-auto grid max-w-6xl gap-8 px-4 py-14 sm:px-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div>
              ...
              <p className="mt-3 text-gray-600 dark:text-gray-300">
                If these sound familiar, the next step is to join Villages and set up the first
                circle around your community.
              </p>
            </div>
        ...
        <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr]">
            <div>
              ...
              <p className="mt-3 text-gray-600 dark:text-gray-300">
                Villages is keeping this early organizer path honest. There is no invented package
                or sales promise here.
              </p>
              <div className="mt-5 grid gap-3 sm:grid-cols-3">
                {notPromised.map((item) => (
                  <div
                    key={item}
                    className="rounded-md border border-amber-100 bg-white p-4 text-sm font-medium shadow-sm dark:border-gray-800 dark:bg-gray-900"
                  >
                    {item}
                  </div>
                ))}
